...
G.Kill = function(I, e)
	...
	_tp(hrp.CFrame * CFrame.new(0, _G.MobHeight or 20, 0))
end
...
function BTP(I)
	...
	repeat
		...
		pcall(function() d.Dialogue.Visible = false end)
...
_G.Settings.FastAttack = true
task.spawn(function() task.wait(2) pcall(function() StartAttacksWithMode("Fast Attack") end) end)
_G.Settings.FastAttack = true
...
local Window = bearlib:MakeWindow({
    Title = "ib fremmium",
    SubTitle = "owned by ib",
    SaveFolder = true,
    Image = "rbxassetid://6764432853",
        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    bearlib:Notify({
                        Title = "ib fremmium",
                        Message = "Error: No coordinates found for this Melee!",
                        Duration = 3
                    })
...
v14:AddSection({"Mua ?? Craft Sea Event"})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Geppo", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Buso Haki", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Soru", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Observation Haki", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Cutlass", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Iron Mace", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Dual Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Triple Katana", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Pipe", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Dual-Headed Blade", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Bisento", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Soul Cane", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Pole V2", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Musket", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Refined Slingshot", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
        bearlib:Notify({Title = "Shop", Message = "?? mua Refined Flintlock", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Cannon", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Kabucha", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Bizarre Rifle", Duration = 2})
    end
})
...
v14:AddSection({"Mua Ph? Ki?n"})

v14:AddButton({
    Name = "Buy Black Cape $50,000",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Black Cape")
        bearlib:Notify({Title = "Shop", Message = "?? mua Black Cape", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Swordsman Hat", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "?? mua Tomoe Ring", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            bearlib:Notify({Title = "Error", Message = "Kh?ng t?m th?y remote Redeem", Duration = 3})
            return
        end
        ...
        bearlib:Notify({Title = "Success", Message = "Tried all codes", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        LowCpu()
        bearlib:Notify({Title = "Optimization", Message = "Enabled Low CPU Mode", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Boats", Message = "Increased boat speed", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Fog", Message = "Removed fog", Duration = 2})
    end
})
